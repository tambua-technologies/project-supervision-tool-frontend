      ...
      <div>
        ...
        >
          <Row>
            ...
            <Col span={6}>
              {procuringEntity.contract.original_contract_sum.currency}{" "}
              {procuringEntity.contract.original_contract_sum.amount}
            </Col>
          ...
          <Row>
            ...
            <Col span={6}>
              {isoDateToHumanReadableDate(
                procuringEntity.contract.commencement_date
              )}
            </Col>
